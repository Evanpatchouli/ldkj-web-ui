  ...
  return (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          "z-[var(--ldkj-z-dropdown)] border border-[color:var(--ldkj-color-border)] bg-[color:var(--ldkj-color-surface)] p-4 text-sm text-[color:var(--ldkj-color-surface-foreground)] outline-none",
        ...
        style={mergeSxStyle(
          ...
          resolveWidth(width),
          roundedStyle,
          shadowStyle ?? { boxShadow: "var(--ldkj-shadow-popover)" },
          sxInlineStyle,
        )}
        {...restProps}
      />
